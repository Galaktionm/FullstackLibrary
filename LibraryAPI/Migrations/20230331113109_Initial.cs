        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userId = table.Column<string>(type: "text", nullable: false),
                    bookId = table.Column<long>(type: "bigint", nullable: false),
                    _rating = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CheckoutscheckoutId = table.Column<long>(type: "bigint", nullable: false),
                    booksbookid = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCheckout", x => new { x.CheckoutscheckoutId, x.booksbookid });
                    table.ForeignKey(
                        name: "FK_BookCheckout_Books_booksbookid",
                        column: x => x.booksbookid,
                        principalTable: "Books",
                        principalColumn: "bookid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCheckout_Checkouts_CheckoutscheckoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCheckout_booksbookid",
                table: "BookCheckout",
                column: "booksbookid");
